        ...
        <div class="col-xl col-lg">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <a href="{{ URL::to('/data-penyakit/create') }}" class="btn btn-primary mb-3"><i
                    ...
                    <table class="table table-bordered" style="width: 100%; border-bottom: 0;">
                        <thead class="bg-primary">
                            <tr>
                                ...
                                <th class="text-white text-center">Detail Penyakit</th>
                                <th class="text-white text-center">Saran Penyakit</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($dataPenyakit as $penyakit)
                                <tr >
                                    ...
                                    <td class="text-justify">{{ $penyakit->detail_penyakit }}</td>
                                    <td class="text-justify">{{ $penyakit->saran_penyakit }}</td>
                                    <td class="text-center d-flex justify-content-center">
                                        <a href="{{ URL::to('/data-penyakit' . '/' . $penyakit->id_penyakit . '/edit') }}"
                                            class="btn btn-warning me-2">
                                            <i class="fas fa-edit mr-1"></i>
                                        </a>
                                        <form action="{{ URL::to('/data-penyakit') . '/' . $penyakit->id_penyakit }}"
