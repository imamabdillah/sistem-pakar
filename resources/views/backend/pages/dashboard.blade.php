            ...
            <div class="card shadow h-100 bg-success">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <i class="fas fa-bug fa-4x text-white" style="opacity: 0.5;"></i>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow h-100 bg-info">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <i class="fas fa-vial fa-4x text-white" style="opacity: 0.5;"></i>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow h-100 bg-warning">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <i class="fas fa-recycle fa-4x text-white" style="opacity: 0.5;"></i>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow h-100" style="background-color: #ff4545">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <i class="fas fa-users fa-4x text-white" style="opacity: 0.5;"></i>
                        </div>
                    </div>
                </div>
            </div>
